...
function App() {
  ...
  //     { id: 12, content: 'Học cách nói những gì cần nói. Suy nghĩ tất cả nhữ…ì bạn nói nhưng đừng nói tất cả những gì bạn nghĩ', isLike: false }
  //   ]
  ...
  const [quoteList, setQuoteList] = useState(() => {
    const data = JSON.parse(localStorage.getItem("quote-list"));
    console.log(data);
    return data ? data : [];
  })
